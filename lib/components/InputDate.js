...
var InputDate = function (props) {
    ...
    return (_jsxs(IonItem, __assign({ id: "choose-date" }, { children: [_jsx(IonLabel, __assign({ color: getColor() }, { children: getTitle() })), _jsx(IonIcon, { slot: "end", color: getColor(), size: "small", icon: calendarClear }), _jsx("p", { children: date }), _jsx(IonModal, __assign({ id: "choose-datetime-modal", ref: dateModal, trigger: "choose-date" }, { children: _jsx(IonDatetime, __assign({ ref: datetime, color: getColor(), presentation: "date", locale: getLocale(), value: props.value, onIonChange: function (e) {
                        if (e.detail.value) {
                            if (props.isConvert) {
                                console.log("true");
