...
var WrappedPicker = function (props) {
    ...
    return (_jsxs(IonItem, __assign({ id: props.type + ident }, { children: [_jsx(IonLabel, __assign({ color: props.color }, { children: props.title })), _jsx(IonIcon, { slot: "end", color: props.color, size: props.sizeIcon, icon: props.icon }), _jsx("p", { children: value }), _jsx(IonModal, __assign({ id: "choose-datetime-modal", ref: modalRef, trigger: props.type + ident }, { children: _jsx(IonDatetime, __assign({ ref: datetimeRef, color: props.color, presentation: props.type, locale: props.locale, onIonChange: function (e) {
                        if (!e.detail.value) {
                            return;
                        }
