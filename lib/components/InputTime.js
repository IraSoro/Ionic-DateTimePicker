...
var InputTime = function (props) {
    ...
    return (_jsxs(IonItem, __assign({ id: "choose-time" }, { children: [_jsx(IonLabel, __assign({ color: getColor() }, { children: getTitle() })), _jsx(IonIcon, { slot: "end", color: getColor(), size: "small", icon: timeSharp }), _jsx("p", { children: time }), _jsx(IonModal, __assign({ id: "choose-datetime-modal", ref: timeModal, trigger: "choose-time" }, { children: _jsx(IonDatetime, __assign({ ref: onlyTime, color: getColor(), presentation: "time", locale: getLocale(), onIonChange: function (e) {
                        if (e.detail.value) {
                            if (props.isConvert) {
